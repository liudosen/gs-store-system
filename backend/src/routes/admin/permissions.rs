...
pub const SUBSCRIPTION_AUTO_RECHARGE_EXECUTE: &str = "subscription:auto-recharge:execute";
...
pub fn all_permission_codes() -> Vec<String> {
    [
        ...
        GOODS_VIEW,
        SUBSCRIPTION_VIEW,
        SUBSCRIPTION_AUTO_RECHARGE_EXECUTE,
            ...
            PermissionGroup {
                ...
                items: vec![
                    ...
                    PermissionItem {
                        ...
                        name: "商品管理".to_string(),
                        description: "访问商品列表、图片素材、规格和 SKU 维护入口".to_string(),
                    },
                    PermissionItem {
                        code: SUBSCRIPTION_VIEW.to_string(),
                        name: "订阅与充值".to_string(),
                        description: "访问订阅、充值和余额流水查询页面".to_string(),
                    },
                    PermissionItem {
                        code: SUBSCRIPTION_AUTO_RECHARGE_EXECUTE.to_string(),
                        name: "执行自动充值".to_string(),
                        description: "控制订阅与充值页面中的自动充值执行按钮".to_string(),
                    },
                    PermissionItem {
