...
:main
set "APP_NAME=gs-store-system"
set "DOCKER_IMAGE=gs-store-system-builder"
...
if not defined DEPLOY_DIR set "DEPLOY_DIR=/root/workspace/gs-store-system"
if not defined DEPLOY_PORT set "DEPLOY_PORT=8081"
if not defined REMOTE_SYSTEM_ENV set "REMOTE_SYSTEM_ENV=/etc/gs-store-system.env"
...
echo ==========================================
echo   gs-store-system Release Builder
echo ==========================================
...
docker build --pull=false -f Dockerfile.linux-build -t %DOCKER_IMAGE% .
if errorlevel 1 (
...
set "CONTAINER_NAME=gs-store-system-build-%RANDOM%"
...
set "ENV_RENDER_PS=%TEMP%\gs-store-system-render-env-%RANDOM%.ps1"
...
>> "%ENV_RENDER_PS%" echo   'DATABASE_URL',
>> "%ENV_RENDER_PS%" echo   'DATABASE_MAX_CONNECTIONS',
>> "%ENV_RENDER_PS%" echo   'DATABASE_MIN_CONNECTIONS',
>> "%ENV_RENDER_PS%" echo   'DATABASE_ACQUIRE_TIMEOUT_SECONDS',
>> "%ENV_RENDER_PS%" echo   'DATABASE_IDLE_TIMEOUT_SECONDS',
>> "%ENV_RENDER_PS%" echo   'DATABASE_MAX_LIFETIME_SECONDS',
...
>> "%ENV_RENDER_PS%" echo   'REDIS_URL',
>> "%ENV_RENDER_PS%" echo   'AUTH_REQUIRE_REDIS_SESSION',
>> "%ENV_RENDER_PS%" echo   'JWT_SECRET',
>> "%ENV_RENDER_PS%" echo   'JWT_EXPIRY_HOURS',
>> "%ENV_RENDER_PS%" echo   'SKIP_MIGRATIONS',
...
>> "%ENV_RENDER_PS%" echo   'DEV_WECHAT_OPENID',
>> "%ENV_RENDER_PS%" echo   'JK_SELLER_USERNAME',
>> "%ENV_RENDER_PS%" echo   'JK_SELLER_PASSWORD',
>> "%ENV_RENDER_PS%" echo   'JK_TEST_SELLER_USERNAME',
>> "%ENV_RENDER_PS%" echo   'JK_TEST_SELLER_PASSWORD',
...
>> "%ENV_RENDER_PS%" echo   'LOG_APP_KEEP_DAYS',
>> "%ENV_RENDER_PS%" echo   'LOG_ERROR_KEEP_DAYS',
